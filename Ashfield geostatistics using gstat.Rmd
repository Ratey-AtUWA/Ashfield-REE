...
private <- "C:/Users/00028958/LocalData/R Projects/"
```

```{r importing the data, message=FALSE, warning=FALSE, results='hold', echo=FALSE}
afs1922 <- read.csv(file="afs1922.csv", stringsAsFactors = TRUE)
afs1922$REE <- with(afs1922, Ce+La+Nd+Gd)
af_border <- read.csv(paste0(private,"Ashfield Flats/afr_hull.csv"))
...
rm(list = c("data_temp","Coords","mI","locMI", "plotdata", "pos0", "neg0",
            "LISA","medREE","HiHi","LoLo","HiLo","LoHi"))
```
...
```{r map-krig-mod-pred, fig.height=10.6, fig.width=8, fig.align='center', fig.cap="Map showing kriging predictions for REE in Ashfield Flats sediments 2019-2022.", message=FALSE, warning=FALSE, echo=FALSE}
...
addscalebar(plotepsg = 32750, pos = "topleft")
points(afs1922surf[,c("Easting","Northing")], pch = 3, col = "grey88", cex = 0.7)
