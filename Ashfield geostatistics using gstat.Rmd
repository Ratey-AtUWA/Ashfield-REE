...
plot(REE_sf[,1], add=T, pch=19, cex=1.5, pal=viridis::plasma(11, alpha=0.7), key.pos=1, axes=T)
```
...
text(150,5e3,pos=2,offset=0, cex=0.95, font=2, family='mono', col = 6,
     labels=paste(
...
```{r map-krig-mod-pred, fig.height=15.9, fig.width=12, fig.align='center', fig.cap="Map showing kriging predictions for REE in Ashfield Flats sediments 2019-2022 by (a) kriging, (b) inverse distance weighted interpolation. Sample points are tiny dots.", message=FALSE, warning=FALSE, echo=FALSE}
...
mtext(side=2, line=1.5, text="Northing (UTM Zone 50, m)",
      font=2, cex=1.8)
plot(kriged_REE, add=T, pch=15, cex=0.925, breaks=52, pal=magma(52,alpha=0.6))
...
mtext(side=2, line=1.5, text="Northing (UTM Zone 50, m)",
      font=2, cex=1.8)
plot(idw_REE, add=T, pch=15, cex=0.925, breaks=32, pal=magma(32,alpha=0.6))
addnortharrow(border=1, lwd=1, text.col=1, padin=c(0.1,0.1), scale = 1.4)
addscalebar(plotepsg = 32750, pos = "bottomleft",htin=0.22, label.cex = 1.8)
points(afs1923surf[,c("Easting","Northing")], pch=19, cex=0.3, col="white")
