...
```{r spplot-spdf, fig.height=5.8, fig.width=8, fig.align='center', out.width="80%", fig.cap="Visualization of sf point data object for log10-transformed REE concentrations in Ashfield Flats sediments 2019-2022.", message=FALSE, warning=FALSE, results='hold', echo=FALSE}
par(oma=c(3,3,1,1), mar=c(4,4,1.5,1.5), mgp=c(1.4,0.3,0), 
    lend=2, ljoin=1, tcl=0.3)
plot_tiles(afstiles)
with(afr_map, polygon(wetland_E, wetland_N, border = "steelblue", col="#87CEEB80"))
