...
```{r spplot-spdf, fig.height=5.8, fig.width=8.4, fig.align='center', out.width="80%", fig.cap="Quick visualization of sf point data object for log10-transformed REE concentrations in Ashfield Flats sediments 2019-2022.", message=FALSE, warning=FALSE, results='hold', echo=FALSE}
...
```{r ree-tukey-plot, echo=2:19, fig.width=10, fig.height=7.3, fig.align='center', fig.cap="Map of REE concentrations expressed as symbols for concentration ranges (UQR is 75th percentile, upWsk is upper whisker, med is median, LQR is 25th percentile, loWsk is lower whisker). Data are from Ashfield Flats sediments 2019-2022.", out.width="80%", message=FALSE, warning=FALSE,echo=FALSE}
...
```{r map-krig-mod-pred, fig.height=16, fig.width=12, fig.align='center', fig.cap="Map showing kriging predictions for REE in Ashfield Flats sediments 2019-2022 by (a) kriging, (b) inverse distance weighted interpolation. Sample points are tiny dots, drains are shown with solid lines, and seasonal wetland pond outlines are semitransparent and dashed.", message=FALSE, warning=FALSE, echo=FALSE}
